...
export const pageData = {
    ...
    commercial: {
      ...
      content:[
        {title:"What is Commercial Solar Power?",content:"Commercial solar power refers to the installation of solar panels at commercial properties to generate electricity. These systems are typically much larger than residential ones and are designed to meet the high energy demands of businesses. Solar panels are often placed on rooftops or large open spaces at commercial properties, capturing sunlight and converting it into electricity through photovoltaic (PV) technology. Commercial solar systems can be connected to the grid, and through net metering, excess power can be sold back to the grid, generating income or reducing electricity bills."},
        {title:"Why is Solar Power Important for Commercial Properties?",content:"FFor commercial properties, solar energy provides a way to reduce operational costs and increase energy efficiency. With rising utility costs and increasing regulatory pressure to adopt cleaner energy sources, solar energy helps businesses become more self-sufficient and less reliant on the grid. By adopting solar power, businesses also improve their corporate image, showcasing their commitment to sustainability and corporate social responsibility."},
        {title:"Technological Advances and Accessibility",content:"Solar technology has evolved significantly over the years, making it more affordable and efficient for commercial applications. Modern panels are capable of capturing more sunlight and producing more energy, even in partially shaded environments. Battery storage systems, which allow businesses to store excess energy for later use, have also become more affordable, offering greater flexibility and energy independence.The process of installing solar systems at commercial properties has become more streamlined, with providers offering end-to-end services that include system design, installation, and maintenance. Additionally, financing options such as leases and power purchase agreements (PPAs) make it easier for businesses to adopt solar without the need for large upfront investments."},
        {title:"The Future of Commercial Energy Security",content:"Commercial solar power offers businesses a path to greater energy security and independence. With solar panels, businesses can generate their own electricity and reduce reliance on the grid. This reduces exposure to rising energy costs and helps businesses avoid the financial uncertainty associated with volatile energy markets.By investing in solar, businesses can also contribute to a more resilient energy grid. When businesses generate their own electricity, they reduce demand on the grid, helping prevent outages and improve energy reliability."},
        {title:"A Sustainable and Profitable Investment",content:"Commercial solar power is an intelligent, forward-thinking investment that can lead to significant savings, enhanced sustainability, and a stronger brand image. By switching to solar, businesses can reduce their environmental footprint, lower their energy costs, and contribute to a cleaner, more resilient energy future. Solar power is not only a solution for today’s energy challenges—it’s a crucial part of tomorrow’s energy landscape."},
      ],
      points: [
